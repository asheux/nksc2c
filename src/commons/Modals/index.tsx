...
import { Modal, Typography, Box, CircularProgress, Stack, Checkbox, Divider } from "@mui/material";
...
export const NKSC2CModal = props => {
  const { open, handleClose, loading, handleChange, errors, errorMessages, isLinked, handleCheckboxChange, payload, modaldata, setModalData, resetData, selectedId, handleOpenBook, handleSubmitNksContrib, token, handleUploadChange } = props;
    ...
    <Modal
      ...
      <Stack
        ...
        <Stack>
          ...
          {modaldata.name ? (
            <Stack direction="row" spacing={0.5}>
              ...
              <NKSTooltip
                title={modaldata.social_link ? "Open social account" : "No social account"}
              >
                <Typography
                ...
                <Stack spacing={1}>
                  ...
                  {isLinked && (
                    <StyledInput
                      ...
                      helperText={errors.social_link && errorMessages.social_link}
                      sx={{
                        width: "70%",
                        "& .MuiOutlinedInput-input": {
                          fontSize: isMobile ? "27px" : "14px",
                  ...
                  <Typography
                    ...
                    Please note that by clicking the button below, you will be the sole contributor and noone else can work on this notebook.
                  </Typography>
                  <Box>
                    <StyledButton
                      disabled={errors.name}
                      onClick={handleSubmitNksContrib}
                      startIcon={nkscontributor.loading ? (
                        <CircularProgress
        ...
        <Stack direction="row" alignItems="center" spacing={0.2}>
          ...
          <NKSTooltip
            title="Download notebook: Before you start working on a notebook, please download an empty version below or download to see what another contributor has done. Upload notebook: This option is for the contributor working on this notebook.">
            <InfoIcon
              sx={{ fontSize: isMobile ? 27 : 18, color: "#b00f00" }}
            />
          </NKSTooltip>
        </Stack>
        <Box>
        ...
        <Modal
          ...
          sx={{ zIndex: 1302 }}>
          <Stack spacing={2} sx={{ ...customStyles.tokenModal, position: "relative" }}>
            <CloseIcon
            ...
            <Stack direction="row" alignItems="center" spacing={0.2}>
              ...
              <NKSTooltip
                title="This is the token provided to you when you started work on this notebook. If you lost it, please contact asheuh49@gmail.com">
                <InfoIcon
